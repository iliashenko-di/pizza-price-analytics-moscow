...
Ручная проверка нужна не для цен, а для сопоставления товаров. Система может автоматически сопоставлять точные названия и пары из конфигурационного файла. Все спорные пары должны попадать в очередь проверки: подтвердить, отклонить, выбрать другую пару или оставить без пары.
