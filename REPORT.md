...
- Papa в snapshot покрыт справочником: 44 из 45 позиций;
- вне Papa-справочника остается "Создай свою пиццу";
- Dodo распределено: 37 из 37 позиций;
- сегментных строк, где Dodo выше Papa: 9;
- сегментных строк, где Dodo ниже Papa: 13;
- к ручной проверке по низкой уверенности попадает "Соберите свою пиццу".
